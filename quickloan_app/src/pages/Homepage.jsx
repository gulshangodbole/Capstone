    ...
    return (
        ...
        <Box>
            ...
            >
                ...
                >
                    <FloatingImage
                        src={"https://images.assettype.com/fortuneindia%2F2022-06%2F1fa744fc-adb4-48fd-a40e-54e45a7edc8b%2FGettyImages_955530262.jpg?rect=0,66,2129,1198&w=1250&q=60"}/>
                </Box>
            ...
            <div id="sectionToScrollTo">
                ...
                <Box m="auto" mt="150px" bgColor={"#f2f2f8"} p="30px" marginTop={"-10px"}>
                    <Flex px={"320px"}>
                        <InfoIcon boxSize={7}/>
                        <Spacer/>
                        <Text pt={"7px"} data-aos="zoom-in" fontFamily={"RNHouseSans, sans-serif"} fontSize={"16px"}>To
                            apply, you must be 18+ and a UK resident with a NatWest current account
            ...
            <Box mx="auto" mt="150px" mb="60px" p="30px" marginTop={"10px"}>
                ...
                <Text mb="40px" fontFamily={"RNHouseSans"} data-aos="zoom-in">You could pay back your loan over one to
                    10 years -
                ...
                <TableContainer px="200px" data-aos="zoom-in">
                    <Table>
                        <Thead>
                            <Tr>
                                <Th borderBottomWidth={"1px"} borderColor={"#00000"}><Text fontFamily={"RNHouseSans"}
                                                                                           fontSize={"18px"}>Loan
                                    amount</Text></Th>
                                <Th borderBottomWidth={"1px"} borderColor={"#00000"}><Text fontFamily={"RNHouseSans"}
                                                                                           fontSize={"18px"}>Time to pay
                                    back</Text></Th>
                            </Tr>
                        ...
                        <Tbody>
                            ...
                            <Tr>
                                <Td borderBottomWidth={"1px"} borderColor={"#00000"}><Text fontFamily={"RNHouseSans"}>£7,500
                                    - £50,000 for home improvements</Text></Td>
                                <Td borderBottomWidth={"1px"} borderColor={"#00000"}><Text fontFamily={"RNHouseSans"}>1
                                    to 10 years</Text></Td>
                            </Tr>
                        </Tbody>
                    </Table>
                ...
                >
                    ...
                    >
                        <CardBody align="center">
                            <Image
                                src={"https://www.nerdwallet.com/assets/blog/wp-content/uploads/2019/10/GettyImages-578269652.jpg"}
                                alt="article_1" borderRadius="lg"/>
                            <Stack textAlign={"left"}>
                                <Heading mt={"15px"} textAlign={"left"} color={"#5a287d"} size="md"
                    ...
                    >
                        <CardBody align="center">
                            <Image
                                src={"https://as1.ftcdn.net/v2/jpg/01/84/82/72/1000_F_184827281_NdcaA8bOLVaQwOBzrGbrP3kmiSJ2mtD0.jpg"}
                                alt="article_2" borderRadius="lg"/>
                            <Stack textAlign={"left"}>
                                <Heading mt={"15px"} textAlign={"left"} color={"#5a287d"} size="md"
                                         fontFamily={"RNHouseSans"}>
                    ...
                    >
                        <CardBody align="center">
                            <Image
                                src={"https://media.istockphoto.com/id/153136893/photo/couple-meeting-with-financial-advisor.jpg?b=1&s=170667a&w=0&k=20&c=Vk2CkL2YUpfZM2HdrL_pAYsIqFhlqUdM5sFIx37ct8c="}
                                alt="article_3" borderRadius="lg"/>
                            <Stack textAlign={"left"}>
                                <Heading mt={"15px"} textAlign={"left"} color={"#5a287d"} size="md"
                                         fontFamily={"RNHouseSans"}>
                    ...
                    >
                        <CardBody align="center">
                            <Image
                                src={"https://media.istockphoto.com/id/1328126737/photo/sign-a-house-sale-agreement.jpg?s=612x612&w=0&k=20&c=Jk7YWa38JMJ5L5b3-U84m2T9_9TIsfIS30rjiGI8t3k="}
                                alt="article_4" borderRadius="lg"/>
                            <Stack textAlign={"left"}>
                                <Heading mt={"15px"} textAlign={"left"} color={"#5a287d"} size="md"
                                         fontFamily={"RNHouseSans"}>
