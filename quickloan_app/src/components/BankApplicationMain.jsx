...
export const BankApplicationMain = () => {
    ...
    const initialUserInfo = {
        ...
        fullname: currentUserbyId?.fullname || currentUser.fullname || "",
        ...
        employer: currentUserbyId?.employment || currentUser?.employment || '',
        jobTitle: '',
        yearsOfEmployment: currentUserbyId?.empYears || currentUser?.empYears || '',
        monthlyIncome: currentUserbyId?.income || currentUser?.income || '',
        monthlyExpenses: '',
        savingsInvestments: '',
        outstandingLoansDebt: '',
        assets:  currentUserbyId?.assets || currentUser?.assets || '',
        identificationProof: '',
        incomeProof: '',
        addressProof: '',
