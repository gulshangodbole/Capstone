        ...
        <Center>
            <Box w={{base: "200px", sm: "150px", md: "300px", lg: "420px", xl: "700px"}}>
                ...
                <Text mt={{base: "50px", sm: "50px", lg: "0px", md: "0px", xl: "0px"}} fontSize={"20px"}
                      fontWeight={"bold"} color={"#283593"}>Supporting Documents</Text>
                ...
                <OrderedList color={'red.600'} textAlign={'left'}>
                    ...
                    <Box display={{base: "block", sm: "block", md: "block", lg: "flex", xl: "flex"}}
                         w={{base: "300px", sm: "250px", md: "800px", lg: "1000px", xl: "1000px"}} mb={"50px"}>

                        <ListItem w={{base: "150px", sm: "150px", lg: "250px", md: "250px", xl: "250px"}} mt={"20px"}>Identification
                            Proof:
                        ...
                        <ListItem w={{base: "150px", sm: "150px", lg: "250px", md: "250px", xl: "250px"}} mt={"20px"}>Income
                            Proof:
                            <UnorderedList textAlign={'left'} color={'black'}>
                        ...
                        <ListItem w={{base: "150px", sm: "150px", lg: "450px", md: "450px", xl: "450px"}} ml={"20px"}
                                  mt={"20px"}>Identification Proof:
                            <UnorderedList textAlign={'left'} color={'black'}>
                                <ListItem>Aadhaar Card </ListItem>
                                <ListItem>Driving License</ListItem>
                                <ListItem>Voter ID Card</ListItem>
                                <ListItem>Utility bills (electricity bill, water bill, gas bill, etc.) in the
                                    applicant's name</ListItem>
                            </UnorderedList>
                        </ListItem>
